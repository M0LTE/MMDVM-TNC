...
const uint8_t  MODE3_SYNC_LENGTH_BYTES   = 4U;
...
const uint8_t  MODE3_SYNC_BYTES[]        = { 0x5D, 0x57U, 0xDFU, 0x7FU};
...
const int8_t MODE3_SYNC_SYMBOLS_VALUES[] = { +3, +3, -3, +3,    +3, +3, +3, -3,   -3, +3, -3, -3,  +3, -3, -3, -3};

const uint16_t MODE3_SYNC_SYMBOLS = 0xDE48U;
